    ...
    <html>
      ...
      <body>
        ...
        <div id="content">
          ...
          <div id="histograms">
            <div id="chart_div_miles" style="width: 600px; height: 250px;"></div>
            <div id="chart_div_cars" style="width: 600px; height: 250px;"></div>
            <div id="chart_div_car-miles" style="width: 600px; height: 250px;"></div>
            <br style="clear:both"/>
          </div>
          <form>
